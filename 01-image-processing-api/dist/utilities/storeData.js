...
exports.appendData = exports.getData = void 0;
var fs_1 = require("fs");
var csvtojson_1 = __importDefault(require("csvtojson"));
var getData = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    var readData, err_1;
...
var appendData = function (data, path) { return __awaiter(void 0, void 0, void 0, function () {
    var csvText, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                // Append data
                return [4 /*yield*/, fs_1.promises.appendFile(path, csvText)];
            case 1:
                // Append data
                _a.sent();
